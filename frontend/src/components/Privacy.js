      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Personal Blog.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            such as a computer, a smartphone or a digital tablet.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Personal Blog, accessible from
            <a
              href={websiteUrl}
